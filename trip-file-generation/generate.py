...
paraiso_regular_trips = generate_trips_uniform(
  ...
  cars_per_trip=1, time_span_seconds=3600, time_offset_seconds=112, cars_per_hour=paraiso_regular_cars
)
...
paraiso_dr_trips = generate_trips_convoy(
  ...
  cars_per_trip=int(paraiso_dr_cars/(3600/120)), time_span_seconds=3600, time_offset_seconds=112, cars_per_hour=paraiso_dr_cars
)
...
consolacao_regular_trips = generate_trips_uniform(
  ...
  cars_per_trip=1, time_span_seconds=3600, time_offset_seconds=115, cars_per_hour=consolacao_regular_cars
)
...
consolacao_dr_trips = generate_trips_convoy(
  ...
  cars_per_trip=int(consolacao_dr_cars/(3600/120)), time_span_seconds=3600, time_offset_seconds=115, cars_per_hour=consolacao_dr_cars
)
